...
// Activities that shows opportunities the user has already registered for
public class RegisteredActivity extends AppCompatActivity implements RecyclerViewAdapter.ClickListener, DialogManager.ClickListener {
